...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    if(message.mentions.users.first().bot) {
      return message.channel.send("**Bots aren't not allowed to have warnings**")
    }
    ...
    await message.channel.send(`Succesfully cleared all warnings of ${message.mentions.users.first().username}`)
